...
def training(model, rounds, batch_size, lr, ds, data_dict, C, K, E, num_malicious, plt_title, plt_color, cifar_data_test,
    ...
    # save data as mat
    savemat("./FL_Gradcam_cifar10_results_{}_{}_{}_{}.mat".format(partition, rounds, m, num_malicious),
...
if __name__ == '__main__':
    ...
    cifar_data_train = datasets.CIFAR10(root='./data', train=True, transform=transform, download=True)
